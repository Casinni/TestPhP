...
class PersonneDBTest extends TestCase
{
    ...
    public function testSelectionNom()
    {
        ...
        $p = new Personne("Valjean", "jean", $dt, "0712233445", "jvaljean@free.fr", "jvaljean", "cosette", new Adresse(55, "Rue du Faubourg Saint-Honoré", 75008, "Paris", 4));
        $p->setPwd("cosette");
        $this->personne->ajout($p);
    ...
    public function testUpdate()
    {
        ...
        $p = new Personne("Martin", "Eric", $dt, "0102030405", "meric@orange.fr", "meric", "4755edd32703675c6a021322f9ca0433", new Adresse(55, "Rue du Faubourg Saint-Honoré", 75008, "Paris", 4));
        //update pers 
