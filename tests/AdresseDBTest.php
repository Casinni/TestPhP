...
class AdresseDBTest extends TestCase
{
    ...
    public function testAjout()
    {
        try {
            ...
            $p = new Adresse(55, "Rue du Faubourg Saint-Honoré", 75008, "Paris", 4);
            //insertion en bdd
    ...
    public function testConvertPdoPers()
    {
        $tab["id"] = 34;
        $tab["numero"] = 55;
        $tab["rue"] = "Rue du Faubourg Saint-Honoré";
        $tab["codepostal"] = 75008;
        $tab["ville"] = "Paris";
        $tab["id_pers"] = 4;
        $this->adresse = new AdresseDB($this->pdodb);
        ...
        $this->assertEquals($tab["id_pers"], $adr->getPersId());
    }
